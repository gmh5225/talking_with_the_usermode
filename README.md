...
Reading from memory given a target process and writing to it is also possible. The Game CSGO is used as a example. The offsets were copied from - [Hazedumper](https://github.com/frk1/hazedumper). (Project as is wont work since offsets are outdated)
